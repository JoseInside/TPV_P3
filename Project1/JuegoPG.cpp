...
void JuegoPG::initMedia() {
	...
	srand(time(NULL));
	archText.push_back("..\\bmps\\fondoMenu.png");
	archText.push_back("..\\bmps\\fondoJuego.png");
	archText.push_back("..\\bmps\\fondoGO.png");
...
void JuegoPG::render(){
	...
	switch (topEstado()->getCurrentState())
	{
	case GAME_STATES::MENU_PRINCIPAL:
		vTexturas[Texturas_t::TFondoMenu]->draw(pRender, aux);
		break;
	case GAME_STATES::PLAY:
		vTexturas[Texturas_t::TFondoJuego]->draw(pRender, aux);
		break;
	case GAME_STATES::PAUSE:
		vTexturas[Texturas_t::TFondoJuego]->draw(pRender, aux);
		break;
	case GAME_STATES::GAME_OVER:
		vTexturas[Texturas_t::TFondoGO]->draw(pRender, aux);
		break;
